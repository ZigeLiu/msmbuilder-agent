...
# LLM agent
# ----------------------------
# Use Ollama's OpenAI-compatible API; the local server ignores the API key.
CLIENT = OpenAI(
...
TOOLS = [{'type': 'function',
  'function': {'name': 'get_current_status',
               'description': 'Get current workflow status, current stage, current run_dir, latest '
                              'summary, and latest plot path.',
               'parameters': {'type': 'object',
                              'properties': {},
                              'required': [],
                              'additionalProperties': False}}},
 {'type': 'function',
  'function': {'name': 'get_current_config',
               ...
               'parameters': {'type': 'object',
                              ...
                              'additionalProperties': False}}},
 {'type': 'function',
  'function': {'name': 'update_config_value',
               'description': 'Update one config field by dotted path. value_yaml can be a scalar, '
                              'list, dict, string, etc.',
               'parameters': {'type': 'object',
                              ...
                              'additionalProperties': False}}},
 {'type': 'function',
  'function': {'name': 'run_inspect_topology',
               'description': 'Inspect the topology of the system. Pass user message for later '
                              'use.',
               'parameters': {'type': 'object',
                              ...
                              'additionalProperties': False}}},
 {'type': 'function',
  'function': {'name': 'run_stage1_featurization',
               ...
               'parameters': {'type': 'object',
                              ...
                              'additionalProperties': False}}},
 {'type': 'function',
  'function': {'name': 'run_stage2_tica_scan',
               'description': 'Run Stage 2: tICA lag scan using the latest Stage 1 result in '
                              'current_run_dir.',
               'parameters': {'type': 'object',
                              'properties': {},
                              'required': [],
                              'additionalProperties': False}}},
 {'type': 'function',
  'function': {'name': 'run_stage3_tica_fit',
               'description': 'Run Stage 3: final tICA fit using current_run_dir and current '
                              'config.',
               'parameters': {'type': 'object',
                              'properties': {},
                              'required': [],
                              'additionalProperties': False}}},
 {'type': 'function',
  'function': {'name': 'run_stage4_cluster',
               ...
               'parameters': {'type': 'object',
                              ...
                              'additionalProperties': False}}},
 {'type': 'function',
  'function': {'name': 'run_stage5_msm_scan',
               'description': 'Run Stage 5: MSM parameter scan using current_run_dir and current '
                              'config.',
               'parameters': {'type': 'object',
                              'properties': {},
                              'required': [],
                              'additionalProperties': False}}},
 {'type': 'function',
  'function': {'name': 'run_stage6_msm_fit',
               ...
               'parameters': {'type': 'object',
                              ...
                              'additionalProperties': False}}},
 {'type': 'function',
  'function': {'name': 'run_stage7_lumpeval',
               'description': 'Run Stage 7: lump and evaluate model using current_run_dir and '
                              'current config.',
               'parameters': {'type': 'object',
                              'properties': {},
                              'required': [],
...
def run_agent_once(
    ...
    # Ollama receives the complete conversation, including tool calls and results.
    max_loops = 8
    for loop in range(max_loops + 1):
        ...
        input_msgs.append({
            ...
            "tool_calls": [fc.model_dump(exclude_none=True) for fc in function_calls],
        })
        for fc in function_calls:
            try:
                args = json.loads(fc.function.arguments or "{}")
                result = execute_tool(st, fc.function.name, args)
